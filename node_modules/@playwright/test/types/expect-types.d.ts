...
//     (self: T, received: any, expected: any, options?: any): ExpectationResult;
...
export interface Matchers<R> {
     ...
     * For testing the items in the list, self uses `===`, a strict equality check.
     */
    toContain(expected: unknown): R;
    /**
     * Used when you want to check that an item is in a list.
     * For testing the items in the list, self  matcher recursively checks the
    ...
    //  * If the last call to the mock function threw an error, then self matcher will fail
    ...
    //  * If the nth call to the mock function threw an error, then self matcher will fail
    //  * no matter what value you provided as the expected return value.
    //  */
