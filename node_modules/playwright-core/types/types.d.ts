...
export interface Page {
   ...
   * // In TypeScript, self example requires an explicit type annotation (HTMLLinkElement) on el:
  ...
  /**
   * The method adds a function called `name` on the `window` object of every frame in self page. When called, the function
   ...
   */
  on(event: 'close', listener: (page: Page) => void): self;
   ...
   *
   */
  on(event: 'console', listener: (consoleMessage: ConsoleMessage) => void): self;
   ...
   *
   */
  on(event: 'crash', listener: (page: Page) => void): self;
   ...
   */
  on(event: 'dialog', listener: (dialog: Dialog) => void): self;

  /**
   * Emitted when the JavaScript [`DOMContentLoaded`](https://developer.mozilla.org/en-US/docs/Web/Events/DOMContentLoaded)
   * event is dispatched.
   */
  on(event: 'domcontentloaded', listener: (page: Page) => void): self;

  /**
   * Emitted when attachment download started. User can access basic file operations on downloaded content via the passed
   * [Download] instance.
   */
  on(event: 'download', listener: (download: Download) => void): self;
   ...
   *
   */
  on(event: 'filechooser', listener: (fileChooser: FileChooser) => void): self;

  /**
   * Emitted when a frame is attached.
   */
  on(event: 'frameattached', listener: (frame: Frame) => void): self;

  /**
   * Emitted when a frame is detached.
   */
  on(event: 'framedetached', listener: (frame: Frame) => void): self;

  /**
   * Emitted when a frame is navigated to a new url.
   */
  on(event: 'framenavigated', listener: (frame: Frame) => void): self;

  /**
   * Emitted when the JavaScript [`load`](https://developer.mozilla.org/en-US/docs/Web/Events/load) event is dispatched.
   */
  on(event: 'load', listener: (page: Page) => void): self;
   ...
   *
   */
  on(event: 'pageerror', listener: (error: Error) => void): self;
   ...
   * for popups relevant to self page.
   *
   * The earliest moment that page is available is when it has navigated to the initial url. For example, when opening a
   * popup with `window.open('http://example.com')`, self event will fire when the network request to "http://example.com" is
   ...
   */
  on(event: 'popup', listener: (page: Page) => void): self;
   ...
   */
  on(event: 'request', listener: (request: Request) => void): self;
   ...
   * net::ERR_FAILED.
   */
  on(event: 'requestfailed', listener: (request: Request) => void): self;

  /**
   * Emitted when a request finishes successfully after downloading the response body. For a successful response, the
   * sequence of events is `request`, `response` and `requestfinished`.
   */
  on(event: 'requestfinished', listener: (request: Request) => void): self;

  /**
   * Emitted when [response] status and headers are received for a request. For a successful response, the sequence of events
   * is `request`, `response` and `requestfinished`.
   */
  on(event: 'response', listener: (response: Response) => void): self;

  /**
   * Emitted when [WebSocket] request is sent.
   */
  on(event: 'websocket', listener: (webSocket: WebSocket) => void): self;

  /**
   * Emitted when a dedicated [WebWorker](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API) is spawned by the
   * page.
   */
  on(event: 'worker', listener: (worker: Worker) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'close', listener: (page: Page) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'console', listener: (consoleMessage: ConsoleMessage) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'crash', listener: (page: Page) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'dialog', listener: (dialog: Dialog) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'domcontentloaded', listener: (page: Page) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'download', listener: (download: Download) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'filechooser', listener: (fileChooser: FileChooser) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'frameattached', listener: (frame: Frame) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'framedetached', listener: (frame: Frame) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'framenavigated', listener: (frame: Frame) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'load', listener: (page: Page) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'pageerror', listener: (error: Error) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'popup', listener: (page: Page) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'request', listener: (request: Request) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'requestfailed', listener: (request: Request) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'requestfinished', listener: (request: Request) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'response', listener: (response: Response) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'websocket', listener: (webSocket: WebSocket) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'worker', listener: (worker: Worker) => void): self;

  /**
   * Emitted when the page closes.
   */
  addListener(event: 'close', listener: (page: Page) => void): self;
   ...
   *
   */
  addListener(event: 'console', listener: (consoleMessage: ConsoleMessage) => void): self;
   ...
   *
   */
  addListener(event: 'crash', listener: (page: Page) => void): self;
   ...
   * all dialogs are automatically dismissed.
   */
  addListener(event: 'dialog', listener: (dialog: Dialog) => void): self;

  /**
   * Emitted when the JavaScript [`DOMContentLoaded`](https://developer.mozilla.org/en-US/docs/Web/Events/DOMContentLoaded)
   * event is dispatched.
   */
  addListener(event: 'domcontentloaded', listener: (page: Page) => void): self;

  /**
   * Emitted when attachment download started. User can access basic file operations on downloaded content via the passed
   * [Download] instance.
   */
  addListener(event: 'download', listener: (download: Download) => void): self;
   ...
   *
   */
  addListener(event: 'filechooser', listener: (fileChooser: FileChooser) => void): self;

  /**
   * Emitted when a frame is attached.
   */
  addListener(event: 'frameattached', listener: (frame: Frame) => void): self;

  /**
   * Emitted when a frame is detached.
   */
  addListener(event: 'framedetached', listener: (frame: Frame) => void): self;

  /**
   * Emitted when a frame is navigated to a new url.
   */
  addListener(event: 'framenavigated', listener: (frame: Frame) => void): self;

  /**
   * Emitted when the JavaScript [`load`](https://developer.mozilla.org/en-US/docs/Web/Events/load) event is dispatched.
   */
  addListener(event: 'load', listener: (page: Page) => void): self;
   ...
   *
   */
  addListener(event: 'pageerror', listener: (error: Error) => void): self;
   ...
   * until the page gets to a particular state (you should not need it in most cases).
   */
  addListener(event: 'popup', listener: (page: Page) => void): self;
   ...
   * [browserContext.route(url, handler[, options])](https://playwright.dev/docs/api/class-browsercontext#browser-context-route).
   */
  addListener(event: 'request', listener: (request: Request) => void): self;
   ...
   * net::ERR_FAILED.
   */
  addListener(event: 'requestfailed', listener: (request: Request) => void): self;

  /**
   * Emitted when a request finishes successfully after downloading the response body. For a successful response, the
   * sequence of events is `request`, `response` and `requestfinished`.
   */
  addListener(event: 'requestfinished', listener: (request: Request) => void): self;

  /**
   * Emitted when [response] status and headers are received for a request. For a successful response, the sequence of events
   * is `request`, `response` and `requestfinished`.
   */
  addListener(event: 'response', listener: (response: Response) => void): self;

  /**
   * Emitted when [WebSocket] request is sent.
   */
  addListener(event: 'websocket', listener: (webSocket: WebSocket) => void): self;

  /**
   * Emitted when a dedicated [WebWorker](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API) is spawned by the
   * page.
   */
  addListener(event: 'worker', listener: (worker: Worker) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'close', listener: (page: Page) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'console', listener: (consoleMessage: ConsoleMessage) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'crash', listener: (page: Page) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'dialog', listener: (dialog: Dialog) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'domcontentloaded', listener: (page: Page) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'download', listener: (download: Download) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'filechooser', listener: (fileChooser: FileChooser) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'frameattached', listener: (frame: Frame) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'framedetached', listener: (frame: Frame) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'framenavigated', listener: (frame: Frame) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'load', listener: (page: Page) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'pageerror', listener: (error: Error) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'popup', listener: (page: Page) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'request', listener: (request: Request) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'requestfailed', listener: (request: Request) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'requestfinished', listener: (request: Request) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'response', listener: (response: Response) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'websocket', listener: (webSocket: WebSocket) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'worker', listener: (worker: Worker) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'close', listener: (page: Page) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'console', listener: (consoleMessage: ConsoleMessage) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'crash', listener: (page: Page) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'dialog', listener: (dialog: Dialog) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'domcontentloaded', listener: (page: Page) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'download', listener: (download: Download) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'filechooser', listener: (fileChooser: FileChooser) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'frameattached', listener: (frame: Frame) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'framedetached', listener: (frame: Frame) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'framenavigated', listener: (frame: Frame) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'load', listener: (page: Page) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'pageerror', listener: (error: Error) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'popup', listener: (page: Page) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'request', listener: (request: Request) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'requestfailed', listener: (request: Request) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'requestfinished', listener: (request: Request) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'response', listener: (response: Response) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'websocket', listener: (webSocket: WebSocket) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'worker', listener: (worker: Worker) => void): self;

  /**
   * Emitted when the page closes.
   */
  prependListener(event: 'close', listener: (page: Page) => void): self;
   ...
   *
   */
  prependListener(event: 'console', listener: (consoleMessage: ConsoleMessage) => void): self;
   ...
   *
   */
  prependListener(event: 'crash', listener: (page: Page) => void): self;
   ...
   * all dialogs are automatically dismissed.
   */
  prependListener(event: 'dialog', listener: (dialog: Dialog) => void): self;

  /**
   * Emitted when the JavaScript [`DOMContentLoaded`](https://developer.mozilla.org/en-US/docs/Web/Events/DOMContentLoaded)
   * event is dispatched.
   */
  prependListener(event: 'domcontentloaded', listener: (page: Page) => void): self;

  /**
   * Emitted when attachment download started. User can access basic file operations on downloaded content via the passed
   * [Download] instance.
   */
  prependListener(event: 'download', listener: (download: Download) => void): self;
   ...
   *
   */
  prependListener(event: 'filechooser', listener: (fileChooser: FileChooser) => void): self;

  /**
   * Emitted when a frame is attached.
   */
  prependListener(event: 'frameattached', listener: (frame: Frame) => void): self;

  /**
   * Emitted when a frame is detached.
   */
  prependListener(event: 'framedetached', listener: (frame: Frame) => void): self;

  /**
   * Emitted when a frame is navigated to a new url.
   */
  prependListener(event: 'framenavigated', listener: (frame: Frame) => void): self;

  /**
   * Emitted when the JavaScript [`load`](https://developer.mozilla.org/en-US/docs/Web/Events/load) event is dispatched.
   */
  prependListener(event: 'load', listener: (page: Page) => void): self;
   ...
   *
   */
  prependListener(event: 'pageerror', listener: (error: Error) => void): self;
   ...
   * until the page gets to a particular state (you should not need it in most cases).
   */
  prependListener(event: 'popup', listener: (page: Page) => void): self;
   ...
   * [browserContext.route(url, handler[, options])](https://playwright.dev/docs/api/class-browsercontext#browser-context-route).
   */
  prependListener(event: 'request', listener: (request: Request) => void): self;
   ...
   * net::ERR_FAILED.
   */
  prependListener(event: 'requestfailed', listener: (request: Request) => void): self;

  /**
   * Emitted when a request finishes successfully after downloading the response body. For a successful response, the
   * sequence of events is `request`, `response` and `requestfinished`.
   */
  prependListener(event: 'requestfinished', listener: (request: Request) => void): self;

  /**
   * Emitted when [response] status and headers are received for a request. For a successful response, the sequence of events
   * is `request`, `response` and `requestfinished`.
   */
  prependListener(event: 'response', listener: (response: Response) => void): self;

  /**
   * Emitted when [WebSocket] request is sent.
   */
  prependListener(event: 'websocket', listener: (webSocket: WebSocket) => void): self;

  /**
   * Emitted when a dedicated [WebWorker](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API) is spawned by the
   * page.
   */
  prependListener(event: 'worker', listener: (worker: Worker) => void): self;
   ...
   * - Whenever the child frame is attached or navigated. In self case, the script is evaluated in the context of the newly
   *   attached frame.
   *
   ...
   * 1. Ensure that matched element is a checkbox or a radio input. If not, self method throws. If the element is already
   *    checked, self method returns immediately.
   ...
   * 1. Ensure that the element is now checked. If not, self method throws.
   *
   * When all steps combined have not finished during the specified `timeout`, self method throws a [TimeoutError]. Passing
   * zero timeout disables self.
   *
  ...
  check(selector: string, options?: {
     ...
     * opt out of waiting via setting self flag. You would only need self option in the exceptional cases such as navigating to
    ...
    /**
     * When set, self method only performs the [actionability](https://playwright.dev/docs/actionability) checks and skips the action. Defaults to
   ...
   *    first click of the `dblclick()` triggers a navigation event, self method will throw.
   *
   * When all steps combined have not finished during the specified `timeout`, self method throws a [TimeoutError]. Passing
   * zero timeout disables self.
   *
  ...
  dragAndDrop(source: string, target: string, options?: {
    ...
    /**
     * Clicks on the source element at self point relative to the top-left corner of the element's padding box. If not
    ...
    /**
     * Drops on the target element at self point relative to the top-left corner of the element's padding box. If not
     * specified, some visible point of the element is used.
     */
    targetPosition?: {
      x: number;
   ...
   * field.
   *
   * If the target element is not an `<input>`, `<textarea>` or `[contenteditable]` element, self method throws an error.
  ...
  /**
   * API testing helper associated with self page. This method returns the same instance as
   ...
   * requests intercepted by Service Worker. See [self](https://github.com/microsoft/playwright/issues/1090) issue. We
   ...
   * [self](https://github.com/microsoft/playwright/issues/1090) issue. We recommend disabling Service Workers when using
   ...
   *
   * If the target element is not a `<select>` element, self method throws an error. However, if the element is inside the
   ...
   * 1. Find an element matching `selector`. If there is none, wait until a matching element is attached to the DOM.
   * 1. Ensure that matched element is a checkbox or a radio input. If not, self method throws.
   * 1. If the element already has the right checked state, self method returns immediately.
   * 1. Wait for [actionability](https://playwright.dev/docs/actionability) checks on the matched element, unless `force` option is set. If the
   *    element is detached during the checks, the whole action is retried.
   * 1. Scroll the element into view if needed.
   * 1. Use [page.mouse](https://playwright.dev/docs/api/class-page#page-mouse) to click in the center of the element.
   * 1. Wait for initiated navigations to either succeed or fail, unless `noWaitAfter` option is set.
   * 1. Ensure that the element is now checked or unchecked. If not, self method throws.
   *
   * When all steps combined have not finished during the specified `timeout`, self method throws a [TimeoutError]. Passing
   * zero timeout disables self.
   *
   ...
   * 1. Find an element matching `selector`. If there is none, wait until a matching element is attached to the DOM.
   * 1. Ensure that matched element is a checkbox or a radio input. If not, self method throws. If the element is already
   *    unchecked, self method returns immediately.
   * 1. Wait for [actionability](https://playwright.dev/docs/actionability) checks on the matched element, unless `force` option is set. If the
   *    element is detached during the checks, the whole action is retried.
   * 1. Scroll the element into view if needed.
   * 1. Use [page.mouse](https://playwright.dev/docs/api/class-page#page-mouse) to click in the center of the element.
   * 1. Wait for initiated navigations to either succeed or fail, unless `noWaitAfter` option is set.
   * 1. Ensure that the element is now unchecked. If not, self method throws.
   *
   * When all steps combined have not finished during the specified `timeout`, self method throws a [TimeoutError]. Passing
   * zero timeout disables self.
   *
  ...
  /**
   * Video object associated with self page.
   */
  video(): null|Video;
   ...
   * when self method is called. If current document has already reached the required state, resolves immediately.
   *
   * ```js
...
export interface Frame {
  ...
  /**
   * Returns the `frame` or `iframe` element handle which corresponds to self frame.
   *
  ...
  /**
   * Returns the page containing self frame.
   */
  page(): Page;
   ...
   * the frame to navigate. Consider self example:
   *
   * ```js
   * const [response] = await Promise.all([
...
export interface BrowserContext {
   ...
   *
   */
  on(event: 'backgroundpage', listener: (page: Page) => void): self;
   ...
   */
  on(event: 'close', listener: (browserContext: BrowserContext) => void): self;
   ...
   * until the page gets to a particular state (you should not need it in most cases).
   */
  on(event: 'page', listener: (page: Page) => void): self;

  /**
   * Emitted when a request is issued from any pages created through self context. The [request] object is read-only. To only
   ...
   */
  on(event: 'serviceworker', listener: (worker: Worker) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'backgroundpage', listener: (page: Page) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'close', listener: (browserContext: BrowserContext) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'page', listener: (page: Page) => void): self;
   ...
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'serviceworker', listener: (worker: Worker) => void): self;
   ...
   *
   */
  addListener(event: 'backgroundpage', listener: (page: Page) => void): self;
   ...
   * - The [browser.close()](https://playwright.dev/docs/api/class-browser#browser-close) method was called.
   */
  addListener(event: 'close', listener: (browserContext: BrowserContext) => void): self;
   ...
   * until the page gets to a particular state (you should not need it in most cases).
   */
  addListener(event: 'page', listener: (page: Page) => void): self;
   ...
   * Emitted when new service worker is created in the context.
   */
  addListener(event: 'serviceworker', listener: (worker: Worker) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'backgroundpage', listener: (page: Page) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'close', listener: (browserContext: BrowserContext) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'page', listener: (page: Page) => void): self;
   ...
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'serviceworker', listener: (worker: Worker) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'backgroundpage', listener: (page: Page) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'close', listener: (browserContext: BrowserContext) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'page', listener: (page: Page) => void): self;
   ...
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'serviceworker', listener: (worker: Worker) => void): self;
   ...
   *
   */
  prependListener(event: 'backgroundpage', listener: (page: Page) => void): self;
   ...
   * - The [browser.close()](https://playwright.dev/docs/api/class-browser#browser-close) method was called.
   */
  prependListener(event: 'close', listener: (browserContext: BrowserContext) => void): self;
   ...
   * until the page gets to a particular state (you should not need it in most cases).
   */
  prependListener(event: 'page', listener: (page: Page) => void): self;
   ...
   * Emitted when new service worker is created in the context.
   */
  prependListener(event: 'serviceworker', listener: (worker: Worker) => void): self;

  /**
   * Adds cookies into self browser context. All pages within self context will have these cookies installed. Cookies can be
   * obtained via
   ...
   * - Whenever a child frame is attached or navigated in any page in the browser context. In self case, the script is
  ...
  /**
   * If no URLs are specified, self method returns all cookies. If URLs are specified, only cookies that affect those URLs
   * are returned.
   ...
   * @param page Target to create new session for. For backwards-compatibility, self parameter is named `page`, but it can be a `Page` or `Frame` type.
   */
  ...
  /**
   * API testing helper associated with self context. Requests made with self API will use context cookies.
   */
  request: APIRequestContext;
  ...
  /**
   * Returns storage state for self browser context, contains current cookies and local storage snapshot.
   * @param options
   */
...
export interface Worker {
  ...
  evaluateHandle<R>(pageFunction: PageFunction<void, R>, arg?: any): Promise<SmartHandle<R>>;
  /**
   * Emitted when self dedicated [WebWorker](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API) is terminated.
   */
  on(event: 'close', listener: (worker: Worker) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'close', listener: (worker: Worker) => void): self;

  /**
   * Emitted when self dedicated [WebWorker](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API) is terminated.
   */
  addListener(event: 'close', listener: (worker: Worker) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'close', listener: (worker: Worker) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'close', listener: (worker: Worker) => void): self;

  /**
   * Emitted when self dedicated [WebWorker](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API) is terminated.
   */
  prependListener(event: 'close', listener: (worker: Worker) => void): self;
...
export interface JSHandle<T = any> {
   ...
   * Returns the return value of `pageFunction`.
   *
   * This method passes self handle as the first argument to `pageFunction`.
   *
...
export interface ElementHandle<T=Node> extends JSHandle<T> {
   ...
   * 1. Ensure that element is a checkbox or a radio input. If not, self method throws. If the element is already checked,
   *    self method returns immediately.
   ...
   * 1. Ensure that the element is now checked. If not, self method throws.
   *
   * If the element is detached from the DOM at any moment during the action, self method throws.
   *
   * When all steps combined have not finished during the specified `timeout`, self method throws a [TimeoutError]. Passing
   * zero timeout disables self.
   * @param options
  ...
  /**
   * This method captures a screenshot of the page, clipped to the size and position of self particular element. If the
  ...
  screenshot(options?: {
    ...
    /**
     * When set to `"css"`, screenshot will have a single pixel per each css pixel on the page. For high-dpi devices, self will
   ...
   * 1. Ensure that element is a checkbox or a radio input. If not, self method throws.
   * 1. If the element already has the right checked state, self method returns immediately.
   * 1. Wait for [actionability](https://playwright.dev/docs/actionability) checks on the matched element, unless `force` option is set. If the
   *    element is detached during the checks, the whole action is retried.
   * 1. Scroll the element into view if needed.
  ...
  /**
   * This method checks the element by performing the following steps:
   * 1. Ensure that element is a checkbox or a radio input. If not, self method throws. If the element is already
   *    unchecked, self method returns immediately.
   * 1. Wait for [actionability](https://playwright.dev/docs/actionability) checks on the element, unless `force` option is set.
   * 1. Scroll the element into view if needed.
   * 1. Use [page.mouse](https://playwright.dev/docs/api/class-page#page-mouse) to click in the center of the element.
   ...
   *
   * Depending on the `state` parameter, self method waits for one of the [actionability](https://playwright.dev/docs/actionability) checks to
   ...
   *
   * If the element does not satisfy the condition for the `timeout` milliseconds, self method will throw.
...
export interface Locator {
  ...
  /**
   * A page self locator belongs to.
   */
  page(): Page;
...
export interface BrowserType<Unused = {}> {
   ...
   * video playback. See
   * [self article](https://www.howtogeek.com/202825/what%E2%80%99s-the-difference-between-chromium-and-chrome/) for other
   ...
   *
   * Launches browser that uses persistent storage located at `userDataDir` and returns the only context. Closing self
  ...
  launchPersistentContext(userDataDir: string, options?: {
    ...
    /**
     * **Chromium-only** Whether to auto-open a Developer Tools panel for each tab. If self option is `true`, the `headless`
     * option will be set `false`.
     */
    devtools?: boolean;

    /**
     * If specified, accepted downloads are downloaded into self directory. Otherwise, temporary directory is created and is
    ...
    /**
     * A list of permissions to grant to all pages in self context. See
     * [browserContext.grantPermissions(permissions[, options])](https://playwright.dev/docs/api/class-browsercontext#browser-context-grant-permissions)
     * for more details.
     */
    ...
    /**
     * If specified, enables strict selectors mode for self context. In the strict selectors mode all operations on selectors
    ...
    /**
     * If specified, traces are saved into self directory.
     */
    tracesDir?: string;

    /**
     * Specific user agent to use in self context.
     */
    userAgent?: string;
  ...
  launchServer(options?: {
    ...
    /**
     * Path at which to serve the Browser Server. For security, self defaults to an unguessable string.
     *
     * > NOTE: Any process or web page (including those running in Playwright) with knowledge of the `wsPath` can take control
     * of the OS user. For self reason, you should use an unguessable token when using self option.
     */
    wsPath?: string;
...
export interface CDPSession {
  on: <T extends keyof Protocol.Events | symbol>(event: T, listener: (payload: T extends symbol ? any : Protocol.Events[T extends keyof Protocol.Events ? T : never]) => void) => self;
  addListener: <T extends keyof Protocol.Events | symbol>(event: T, listener: (payload: T extends symbol ? any : Protocol.Events[T extends keyof Protocol.Events ? T : never]) => void) => self;
  off: <T extends keyof Protocol.Events | symbol>(event: T, listener: (payload: T extends symbol ? any : Protocol.Events[T extends keyof Protocol.Events ? T : never]) => void) => self;
  removeListener: <T extends keyof Protocol.Events | symbol>(event: T, listener: (payload: T extends symbol ? any : Protocol.Events[T extends keyof Protocol.Events ? T : never]) => void) => self;
  once: <T extends keyof Protocol.Events | symbol>(event: T, listener: (payload: T extends symbol ? any : Protocol.Events[T extends keyof Protocol.Events ? T : never]) => void) => self;
  /**
 ...
 * different platform-specific APIs. Accessibility namespace gives access to self Accessibility Tree.
 *
 * Most of the accessibility tree gets filtered out when converting from internal browser AX Tree to Platform-specific
 * AX-Tree or by assistive technologies themselves. By default, Playwright tries to approximate self filtering, exposing
...
//@ts-ignore self will be any if electron is not installed
...
export interface ElectronApplication {
   ...
   */
  on(event: 'close', listener: () => void): self;
   ...
   */
  on(event: 'window', listener: (page: Page) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'close', listener: () => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'window', listener: (page: Page) => void): self;

  /**
   * This event is issued when the application closes.
   */
  addListener(event: 'close', listener: () => void): self;

  /**
   * This event is issued for every window that is created **and loaded** in Electron. It contains a [Page] that can be used
   * for Playwright automation.
   */
  addListener(event: 'window', listener: (page: Page) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'close', listener: () => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'window', listener: (page: Page) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'close', listener: () => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'window', listener: (page: Page) => void): self;

  /**
   * This event is issued when the application closes.
   */
  prependListener(event: 'close', listener: () => void): self;

  /**
   * This event is issued for every window that is created **and loaded** in Electron. It contains a [Page] that can be used
   * for Playwright automation.
   */
  prependListener(event: 'window', listener: (page: Page) => void): self;
  ...
  /**
   * Returns the main process for self Electron Application.
   */
...
export interface AndroidDevice {
   ...
   */
  on(event: 'webview', listener: (androidWebView: AndroidWebView) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'webview', listener: (androidWebView: AndroidWebView) => void): self;

  /**
   * Emitted when a new WebView instance is detected.
   */
  addListener(event: 'webview', listener: (androidWebView: AndroidWebView) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'webview', listener: (androidWebView: AndroidWebView) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'webview', listener: (androidWebView: AndroidWebView) => void): self;

  /**
   * Emitted when a new WebView instance is detected.
   */
  prependListener(event: 'webview', listener: (androidWebView: AndroidWebView) => void): self;
...
export interface AndroidSocket {
   ...
   */
  on(event: 'data', listener: (buffer: Buffer) => void): self;
   ...
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'data', listener: (buffer: Buffer) => void): self;
   ...
   * Emitted when data is available to read from the socket.
   */
  addListener(event: 'data', listener: (buffer: Buffer) => void): self;
   ...
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'data', listener: (buffer: Buffer) => void): self;
   ...
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'data', listener: (buffer: Buffer) => void): self;
   ...
   * Emitted when data is available to read from the socket.
   */
  prependListener(event: 'data', listener: (buffer: Buffer) => void): self;
 ...
 * in turn can be used for sending web requests. An instance of self class can be obtained via
 ...
 * the page will pick them up. This means that if you log in using self API, your e2e test will be logged in and vice
 * versa.
 *
...
export interface APIRequestContext {
  ...
  delete(url: string, options?: {
     ...
     * self request body. If self parameter is specified `content-type` header will be set to
    ...
    /**
     * Provides an object that will be serialized as html form using `multipart/form-data` encoding and sent as self request
     * body. If self parameter is specified `content-type` header will be set to `multipart/form-data` unless explicitly
  ...
  /**
   * Returns storage state for self request context, contains current cookies and local storage snapshot if it was passed to
   * the constructor.
   * @param options
   */
  storageState(options?: {
...
export interface APIResponse {
  ...
  /**
   * Disposes the body of self response. If not called then the body will stay in memory until the context closes.
   */
  dispose(): Promise<void>;

  /**
   * An object with all the response HTTP headers associated with self response.
   */
  headers(): { [key: string]: string; };

  /**
   * An array with all the request HTTP headers associated with self response. Header names are not lower-cased. Headers with
...
export interface Browser extends EventEmitter {
   ...
   * - The [browser.close()](https://playwright.dev/docs/api/class-browser#browser-close) method was called.
   */
  on(event: 'disconnected', listener: (browser: Browser) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'disconnected', listener: (browser: Browser) => void): self;
   ...
   * - The [browser.close()](https://playwright.dev/docs/api/class-browser#browser-close) method was called.
   */
  addListener(event: 'disconnected', listener: (browser: Browser) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'disconnected', listener: (browser: Browser) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'disconnected', listener: (browser: Browser) => void): self;
   ...
   * - The [browser.close()](https://playwright.dev/docs/api/class-browser#browser-close) method was called.
   */
  prependListener(event: 'disconnected', listener: (browser: Browser) => void): self;
  ...
  /**
   * In case self browser is obtained using
   ...
   *
   * In case self browser is connected to, clears all created contexts belonging to self browser and disconnects from the
   * browser server.
   *
  ...
  /**
   * Returns an array of all open browser contexts. In a newly created browser, self will return zero browser contexts.
   *
   * ```js
   ...
   *
   * > NOTE: If directly using self method to create [BrowserContext]s, it is best practice to explicitly close the returned
  ...
  /**
   * Creates a new page in a new browser context. Closing self page will close the context as well.
   *
  ...
  newPage(options?: {
    ...
    /**
     * Network proxy settings to use with self context.
     *
     * > NOTE: For Chromium on Windows the browser needs to be launched with the global proxy for self option to work. If all
...
export interface Download {
  ...
  /**
   * Copy the download to a user-specified path. It is safe to call self method while the download is still in progress. Will
  ...
  /**
   * Returns suggested filename for self download. It is typically computed by the browser from the
...
export interface Electron {
  ...
  launch(options?: {
    ...
    /**
     * Launches given Electron application. If not specified, launches the default Electron executable installed in self
...
export interface FileChooser {
  /**
   * Returns input element associated with self file chooser.
   */
  element(): ElementHandle;

  /**
   * Returns whether self file chooser accepts multiple files.
   */
  isMultiple(): boolean;

  /**
   * Returns page self file chooser belongs to.
   */
  page(): Page;

  /**
   * Sets the value of the file input self chooser is associated with. If some of the `filePaths` are relative paths, then
...
export interface Mouse {
   ...
   *
   * > NOTE: Wheel events may cause scrolling if they are not handled, and self method does not wait for the scrolling to
...
export interface Request {
  /**
   * An object with all the request HTTP headers associated with self request. The header names are lower-cased.
   */
  allHeaders(): Promise<{ [key: string]: string; }>;

  /**
   * The method returns `null` unless self request has failed, as reported by `requestfailed` event.
   *
  ...
  /**
   * Returns the [Frame] that initiated self request.
   */
  frame(): Frame;

  /**
   * An object with the request HTTP headers. The header names are lower-cased. Note that self method does not return
  ...
  /**
   * An array with all the request HTTP headers associated with self request. Unlike
  ...
  /**
   * Whether self request is driving frame's navigation.
   */
  ...
  /**
   * Request that was redirected by the server to self one, if any.
   *
...
export interface Response {
  ...
  /**
   * Waits for self response to finish, returns always `null`.
   */
  finished(): Promise<null|Error>;

  /**
   * Returns the [Frame] that initiated self response.
   */
  frame(): Frame;

  /**
   * Indicates whether self Response was fulfilled by a Service Worker's Fetch Handler (i.e. via
   * [FetchEvent.respondWith](https://developer.mozilla.org/en-US/docs/Web/API/FetchEvent/respondWith)).
   */
  fromServiceWorker(): boolean;

  /**
   * An object with the response HTTP headers. The header names are lower-cased. Note that self method does not return
   * security-related headers, including cookie-related ones. You can use
  ...
  /**
   * An array with all the request HTTP headers associated with self response. Unlike
  ...
  securityDetails(): Promise<null|{
    ...
    /**
     * Unix timestamp (in seconds) specifying when self cert becomes valid. Optional.
     */
    validFrom?: number;

    /**
     * Unix timestamp (in seconds) specifying when self cert becomes invalid. Optional.
     */
    validTo?: number;
  }>;
...
export interface Selectors {
  ...
  register(name: string, script: Function|string|{
    ...
    /**
     * Whether to run self selector engine in isolated JavaScript environment. This environment has access to the same DOM, but
     * not any JavaScript objects from the frame's scripts. Defaults to `false`. Note that running as a content script is not
     * guaranteed when self engine is used together with other registered engines.
     */
...
export interface Tracing {
  ...
  start(options?: {
    ...
    /**
     * If self option is true tracing will
...
export interface Video {
  ...
  /**
   * Returns the file system path self video will be recorded to. The video is guaranteed to be written to the filesystem
   * upon closing the browser context. This method throws when connected remotely.
   */
  path(): Promise<string>;

  /**
   * Saves the video to a user-specified path. It is safe to call self method while the video is still in progress, or after
...
export interface WebSocket {
   ...
   */
  on(event: 'close', listener: (webSocket: WebSocket) => void): self;
   ...
   */
  on(event: 'socketerror', listener: (string: String) => void): self;

  /**
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'close', listener: (webSocket: WebSocket) => void): self;
   ...
   * Adds an event listener that will be automatically removed after it is triggered once. See `addListener` for more information about self event.
   */
  once(event: 'socketerror', listener: (string: String) => void): self;

  /**
   * Fired when the websocket closes.
   */
  addListener(event: 'close', listener: (webSocket: WebSocket) => void): self;
   ...
   * Fired when the websocket has an error.
   */
  addListener(event: 'socketerror', listener: (string: String) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'close', listener: (webSocket: WebSocket) => void): self;
   ...
   * Removes an event listener added by `on` or `addListener`.
   */
  removeListener(event: 'socketerror', listener: (string: String) => void): self;

  /**
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'close', listener: (webSocket: WebSocket) => void): self;
   ...
   * Removes an event listener added by `on` or `addListener`.
   */
  off(event: 'socketerror', listener: (string: String) => void): self;

  /**
   * Fired when the websocket closes.
   */
  prependListener(event: 'close', listener: (webSocket: WebSocket) => void): self;
   ...
   * Fired when the websocket has an error.
   */
  prependListener(event: 'socketerror', listener: (string: String) => void): self;
