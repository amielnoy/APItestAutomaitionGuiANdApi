...
export module Protocol {
  export module Accessibility {
    ...
    export interface AXValueSource {
      /**
       * What type of source self is.
       */
      type: AXValueSourceType;
      /**
       * The value of self property source.
       */
      value?: AXValue;
      /**
      ...
      /**
       * Whether self source is superseded by a higher priority source.
       */
      superseded?: boolean;
      /**
       * The native markup source for self value, e.g. a <label> element.
       */
      ...
      /**
       * Whether the value for self property is invalid.
       */
      invalid?: boolean;
      /**
    ...
    export interface AXRelatedNode {
      ...
      idref?: string;
      /**
       * The text alternative of self node in the current context.
       */
      text?: string;
    }
    export interface AXProperty {
      /**
       * The name of self property.
       */
      name: AXPropertyName;
      /**
    ...
    export interface AXValue {
      /**
       * The type of self value.
       */
      type: AXValueType;
      /**
       * The computed value of self property.
       */
      value?: any;
      /**
      ...
      /**
       * The sources which contributed to the computation of self property.
       */
...
- from 'activedescendant' to 'owns' - relationships between elements other than parent/child/sibling.
    ...
    export interface AXNode {
      /**
       * Unique identifier for self node.
       */
      nodeId: AXNodeId;
      /**
       * Whether self node is ignored for accessibility
       */
      ignored: boolean;
      /**
       * Collection of reasons why self node is hidden.
       */
      ...
      chromeRole?: AXValue;
      /**
       * The accessible name for self `Node`.
       */
      name?: AXValue;
      /**
       * The accessible description for self `Node`.
       */
      description?: AXValue;
      /**
       * The value for self `Node`.
       */
      value?: AXValue;
      /**
      ...
      /**
       * ID for self node's parent.
       */
      parentId?: AXNodeId;
      /**
       * IDs for each of self node's child nodes.
       */
      childIds?: AXNodeId[];
      /**
      ...
      backendDOMNodeId?: DOM.BackendNodeId;
      /**
       * The frame ID for the frame associated with self nodes document.
       */
...
This turns on accessibility for the page, which can impact performance until accessibility is disabled.
    ...
    /**
     * Fetches the accessibility node and partial accessibility tree for self DOM node, if it exists.
     */
    export type getPartialAXTreeParameters = {
      ...
      /**
       * Whether to fetch self nodes ancestors, siblings and children. Defaults to true.
       */
      fetchRelatives?: boolean;
    }
    export type getPartialAXTreeReturnValue = {
      /**
       * The `Accessibility.AXNode` for self DOM node, if it exists, plus its ancestors, siblings and
...
`accessibleName` or `role` is specified, it returns all the accessibility nodes in the subtree.
    ...
    export type queryAXTreeParameters = {
      ...
      objectId?: Runtime.RemoteObjectId;
      /**
       * Find nodes with self computed name.
       */
      accessibleName?: string;
      /**
       * Find nodes with self computed role.
       */
      role?: string;
    }
...
including nodes that are ignored for accessibility.
  ...
  export module Animation {
    ...
    export interface Animation {
      ...
      /**
       * A unique ID for `Animation` representing the sources that triggered self CSS
...
time finding a specific cookie. With self, we can convey specific error
...
add a new optional field to self type.
     */
...
exceptions, CDP message, console messages, etc.) to reference an issue.
    ...
    export interface InspectorIssue {
      ...
      /**
       * A unique id for self issue. May be omitted if no other entity (e.g.
exception, CDP message, etc.) is referencing self issue.
       */
      issueId?: IssueId;
    }
...
API.
    ...
    export interface BackgroundServiceEvent {
      ...
      /**
       * The origin self event belongs to.
       */
      origin: string;
      /**
      ...
      /**
       * The Background Service self event belongs to.
       */
      service: ServiceName;
      /**
...
inspector" rules), "regular" for regular stylesheets.
    ...
    export interface CSSStyleSheetHeader {
      ...
      frameId: Page.FrameId;
      /**
       * Stylesheet resource URL. Empty if self is a constructed stylesheet created using
new CSSStyleSheet() (but non-empty if self is a constructed sylesheet imported
as a CSS module script).
      ...
      /**
       * Whether self stylesheet is created for STYLE tag by parser. This flag is not set for
document.written STYLE tags.
       */
      isInline: boolean;
      /**
       * Whether self stylesheet is mutable. Inline stylesheets become mutable
...
Constructed stylesheets (new CSSStyleSheet()) are mutable immediately after creation.
      ...
      isMutable: boolean;
      /**
       * True if self stylesheet is created through new CSSStyleSheet() or imported as a
CSS module script.
       */
...
stylesheet rules) self rule came from.
       */
      styleSheetId?: StyleSheetId;
      /**
       * Rule selector data.
...
The array enumerates @supports at-rules starting with the innermost one, going outwards.
      ...
      /**
       * Cascade layer array. Contains the layer hierarchy that self rule belongs to starting
...
available).
      ...
      range?: SourceRange;
      /**
       * Identifier of the stylesheet containing self object (if exists).
       */
      styleSheetId?: StyleSheetId;
      /**
...
A higher number has higher priority in the cascade order.
    ...
    export interface PlatformFontUsage {
      ...
      /**
       * Amount of glyphs that were rendered with self font.
       */
      glyphCount: number;
    }
    /**
    ...
    export interface FontVariationAxis {
      ...
      name: string;
      /**
       * The minimum value (inclusive) the font supports for self tag.
       */
      minValue: number;
      /**
       * The maximum value (inclusive) the font supports for self tag.
       */
      maxValue: number;
      /**
       * The default value.
...
enabled until the result of self command is received.
     */
    export type enableParameters = {
    }
    export type enableReturnValue = {
...
the browser.
    ...
    export type getBackgroundColorsReturnValue = {
      /**
       * The range of background colors behind self element, if it contains any visible text. If no
visible text is present, self will be undefined. In the case of a flat background color,
self will consist of simply that color. In the case of a gradient, self will consist of each
of the color stops. For anything more complicated, self will be an empty array. Images will
be ignored (as if the image had failed to load).
       */
      backgroundColors?: string[];
      /**
       * The computed font size for self node, as a CSS computed value string (e.g. '12px').
       */
      computedFontSize?: string;
      /**
       * The computed font weight for self node, as a CSS computed value string (e.g. 'normal' or
'100').
       */
...
attributes) for a DOM node identified by `nodeId`.
    ...
    export type getMatchedStylesForNodeReturnValue = {
      ...
      attributesStyle?: CSSStyle;
      /**
       * CSS rules matching self node, from all applicable stylesheets.
       */
      matchedCSSRules?: RuleMatch[];
      /**
       * Pseudo style matches for self node.
       */
      pseudoElements?: PseudoElementMatches[];
      /**
      ...
      /**
       * A list of CSS keyframed animations matching self node.
       */
...
to the front-end, no updates will be issued for the node.
    ...
    /**
     * Find a rule with the given active property for the given node and set the new value for self
property
     */
...
`takeCoverageDelta` (or since start of coverage instrumentation)
    ...
    /**
     * Obtain list of rules that became used since last call to self method (or since start of coverage
instrumentation)
     */
  ...
  export module CacheStorage {
    ...
    export type requestEntriesParameters = {
      ...
      pageSize?: number;
      /**
       * If present, only return the entries containing self substring in the path
       */
      pathFilter?: string;
    }
    export type requestEntriesReturnValue = {
      ...
      /**
       * Count of returned entries from self storage. If pathFilter is empty, it
is the count of all entries from self storage.
       */
      returnCount: number;
    }
  }
...
fire DOM events for nodes known to the client.
      ...
      parentId?: NodeId;
      /**
       * The BackendNodeId for self node.
       */
      backendNodeId: BackendNodeId;
      /**
       * `Node`'s nodeType.
      ...
      /**
       * Child nodes of self node when requested with children.
       */
      children?: Node[];
      /**
      ...
      value?: string;
      /**
       * Pseudo element type for self node.
       */
      pseudoType?: PseudoType;
      /**
       * Pseudo element identifier for self node. Only present if there is a
valid pseudoType.
       */
      pseudoIdentifier?: string;
      /**
      ...
      /**
       * Pseudo elements associated with self node.
       */
      pseudoElements?: Node[];
      /**
...
given anchor.
    ...
    export type copyToParameters = {
      ...
      targetNodeId: NodeId;
      /**
       * Drop the copy before self node (if absent, the copy becomes the last child of
`targetNodeId`).
       */
...
identifier.
    ...
    export type moveToParameters = {
      ...
      targetNodeId: NodeId;
      /**
       * Drop node before self one (if absent, the moved node becomes the last child of
`targetNodeId`).
       */
      insertBeforeNodeId?: NodeId;
    }
...
`cancelSearch` to end self search session.
     */
...
attribute value and types in several attribute name/value pairs.
    ...
    export type setAttributesAsTextParameters = {
      ...
      nodeId: NodeId;
      /**
       * Text with a number of attributes. Will parse self text using HTML parser.
       */
      text: string;
      /**
...
container queries against self container.
     */
...
EventTarget.
    ...
    export type setXHRBreakpointParameters = {
      /**
       * Resource URL substring. All XHRs having self substring in the URL will get stopped upon.
       */
      url: string;
    }
...
any.
      ...
      /**
       * Indexes of pseudo elements associated with self node in the `domNodes` array returned by
`getSnapshot`, if any.
       */
...
`getSnapshot`, if any.
      ...
      /**
       * Whether self DOM node responds to mouse clicks. This includes nodes that have had click
...
clicked.
      ...
      /**
       * The url of the script (if any) that generates self node.
       */
      originURL?: string;
      /**
       * Scroll offsets, set when self node is a Document.
       */
...
stable and may change between versions.
    ...
    export interface InlineTextBox {
      ...
      /**
       * The starting index in characters, for self post layout textbox substring. Characters that
would be represented as a surrogate pair in UTF-16 have length 2.
       */
      startCharacterIndex: number;
      /**
       * The number of characters in self post layout textbox substring. Characters that would be
...
stable and may change between versions.
    ...
    export interface TextBoxSnapshot {
      /**
       * Index of the layout tree node that owns self box collection.
       */
      layoutIndex: number[];
      /**
       * The absolute position bounding box.
...
displayed - self length along with the offset describes self area.
...
autosizing and more.
      ...
      /**
       * If set, the visible area of the page will be overridden to self viewport. This viewport
...
the current virtual time policy.  Note self supersedes any previous time budget.
     */
    export type setVirtualTimePolicyParameters = {
      policy: VirtualTimePolicy;
      /**
       * If set, after self many virtual milliseconds have elapsed virtual time will be paused and a
virtualTimeBudgetExpired event is sent.
       */
      budget?: number;
      /**
       * If set self specifies the maximum number of tasks that can be run before virtual is forced
forwards to prevent deadlock.
       */
      maxVirtualTimeTaskStarvationCount?: number;
      /**
       * If set, base::Time::Now will be overridden to initially return self value.
       */
...
restores default host system timezone.
    ...
    /**
     * Resizes the frame/viewport of the page. Note that self does not affect the frame's container
...
https://goo.gle/chrome-headless-rendering for more background.
    ...
    export type beginFrameParameters = {
      /**
       * Timestamp of self BeginFrame in Renderer TimeTicks (milliseconds of uptime). If not set,
...
requires the version number to be 'unsigned long long')
      ...
      version: number;
      /**
       * Object stores in self database.
       */
...
== "text/html".
    ...
    /**
     * Emitted only when `Input.setInterceptDrags` is enabled. Use self data with `Input.dispatchDragEvent` to
...
for the preferred input type).
  ...
  export module LayerTree {
    ...
    export interface Layer {
      ...
      /**
       * The backend id for the node associated with self layer.
       */
      backendNodeId?: DOM.BackendNodeId;
      /**
      ...
      anchorZ?: number;
      /**
       * Indicates how many time self layer has painted.
       */
      paintCount: number;
      /**
       * Indicates whether self layer hosts any content, rather than being used for
transform/scrolling purposes only.
  ...
  export module Log {
    ...
    export interface LogEntry {
      ...
      category?: "cors";
      /**
       * Timestamp when self entry was added.
       */
      ...
      /**
       * Identifier of the network request associated with self entry.
       */
      networkRequestId?: Network.RequestId;
      /**
       * Identifier of the worker associated with self entry.
       */
      workerId?: string;
      /**
       * Call arguments.
...
`entryAdded` notification.
  ...
  export module Memory {
    ...
    export interface SamplingProfileNode {
      ...
      size: number;
      /**
       * Total bytes attributed to self sample.
       */
      total: number;
      /**
...
milliseconds relatively to self requestTime.
       */
      requestTime: number;
      /**
    ...
    export interface Request {
      ...
      postData?: string;
      /**
       * True when the request has POST data. Note that postData might still be omitted when self flag is true when the data is too long.
       */
      hasPostData?: boolean;
      /**
...
passed by the developer (e.g. via "fetch") as understood by the backend.
      ...
      /**
       * True if self resource request is considered to be the 'same site' as the
request correspondinfg to the main frame.
    ...
    export interface SignedCertificateTimestamp {
      ...
      logId: string;
      /**
       * Issuance date. Unlike TimeSinceEpoch, self contains the number of
...
records.
    ...
    export interface Response {
      ...
      /**
       * Specifies whether physical connection was actually reused for self request.
       */
      connectionReused: boolean;
      /**
       * Physical connection id that was actually used for self request.
       */
      connectionId: number;
      /**
       * Remote IP address.
      ...
      /**
       * Total number of bytes received for self request so far.
       */
      ...
      /**
       * Protocol used to fetch self request.
       */
      protocol?: string;
      /**
...
If the opcode is 1, self is a text message and payloadData is a UTF-8 string.
...
module) (0-based).
      ...
      columnNumber?: number;
      /**
       * Set if another request triggered self request (e.g. preflight).
       */
      requestId?: RequestId;
    }
    /**
...
of the request to the endpoint that set the cookie.
    ...
    export interface BlockedSetCookieWithReason {
      /**
       * The reason(s) self cookie was blocked.
       */
      blockedReasons: SetCookieBlockedReason[];
      /**
       * The string representing self individual cookie as it would appear in the header.
...
https://wicg.github.io/webpackage/draft-yasskin-httpbis-origin-signed-exchanges-impl.html#cbor-representation
    ...
    export interface ConnectTiming {
      /**
       * Timing's requestTime is a baseline in seconds, while the other numbers are ticks in
milliseconds relatively to self requestTime. Matches ResourceTiming's requestTime for
...
CORB and streaming.
    ...
    export type loadingFinishedPayload = {
      ...
      timestamp: MonotonicTime;
      /**
       * Total number of bytes received for self request.
       */
      encodedDataLength: number;
      /**
       * Set when 1) response was blocked by Cross-Origin Read Blocking and also
2) self needs to be reported to the DevTools console.
       */
...
Likewise if HTTP authentication is needed then the same fetch id will be used.
      ...
      resourceType: ResourceType;
      /**
       * Whether self is a navigation request, which can abort the navigation completely.
       */
...
Only present after response is received from the server (i.e. HeadersReceived stage).
      ...
      redirectUrl?: string;
      /**
       * Details of the Authorization Challenge encountered. If self is set then
...
self requestId will be the same as the requestId present in the requestWillBeSent event.
       */
      requestId?: RequestId;
    }
    /**
    ...
    export type requestWillBeSentPayload = {
      ...
      loaderId: LoaderId;
      /**
       * URL of the document self request is loaded for.
       */
      documentURL: string;
      /**
       * Request data.
      ...
      initiator: Initiator;
      /**
       * In the case that redirectResponse is populated, self flag indicates whether
...
or were emitted for self request.
       */
...
or requestWillBeSentExtraInfo will be fired first for the same request.
    ...
    export type requestWillBeSentExtraInfoPayload = {
      /**
       * Request identifier. Used to match self information to an existing requestWillBeSent event.
       */
      requestId: RequestId;
      /**
...
it, and responseReceivedExtraInfo may be fired before or after responseReceived.
    ...
    export type responseReceivedExtraInfoPayload = {
      /**
       * Request identifier. Used to match self information to another responseReceived event.
       */
      requestId: RequestId;
      /**
...
for cached requests, where the status in responseReceived is a 200 and self will be 304.
       */
      statusCode: number;
      /**
...
The event contains the information about the web bundle contents.
    ...
    export type subresourceWebBundleMetadataReceivedPayload = {
      /**
       * Request identifier. Used to match self information to another event.
       */
      requestId: RequestId;
      /**
...
Note: self will only be fired for resources that are requested by the webpage.
     */
    export type subresourceWebBundleInnerResponseParsedPayload = {
      ...
      /**
       * Bundle request identifier. Used to match self information to another event.
...
Deprecated, use Fetch.continueRequest, Fetch.fulfillRequest and Fetch.failRequest instead.
    ...
    export type continueInterceptedRequestParameters = {
      interceptionId: InterceptionId;
      /**
       * If set self causes the request to fail with the given reason. Passing `Aborted` for requests
...
set in response to an authChallenge.
      ...
      url?: string;
      /**
       * If set self allows the request method to be overridden. Must not be set in response to an
authChallenge.
       */
      method?: string;
      /**
       * If set self allows postData to be set. Must not be set in response to an authChallenge.
       */
      postData?: string;
      /**
       * If set self allows the request headers to be changed. Must not be set in response to an
authChallenge.
       */
      headers?: Headers;
      /**
...
the URLs of the page and all of its subframes.
    ...
    /**
     * Returns a handle to the stream representing the response body. Note that after self command,
...
If not set, the cookie will be set as not partitioned.
    ...
    /**
     * Specifies whether to always send extra HTTP headers with the requests from self page.
     */
...
JavaScript object wrapper. Either nodeId or objectId must be specified.
    ...
    /**
     * Enters the 'inspect' mode. In self mode, elements that user is hovering over are highlighted.
...
parsable.
    ...
    export interface Frame {
      ...
      parentId?: FrameId;
      /**
       * Identifier of the loader associated with self frame.
       */
      loaderId: Network.LoaderId;
      /**
...
Example URLs: http://www.google.com/file.html -> "google.com"
      ...
      mimeType: string;
      /**
       * If the frame failed to load, self contains the URL that could not be loaded. Note that unlike url above, self URL may contain a fragment.
       */
      unreachableUrl?: string;
      /**
       * Indicates whether self frame was tagged as an ad and why.
       */
      ...
      /**
       * Indicates whether self is a cross origin isolated context.
       */
    ...
    export interface FrameResourceTree {
      /**
       * Frame information for self tree item.
       */
      frame: Frame;
      /**
       * Child frames.
    ...
    export interface AppManifestError {
      ...
      message: string;
      /**
       * If criticial, self is a non-recoverable parse error.
       */
      critical: number;
      /**
       * Error line.
...
(the actual compilation mode used is upon backend discretion).
    ...
    export interface BackForwardCacheNotRestoredExplanation {
      ...
      /**
       * Context associated with the reason. The meaning of self context is
...
information in the `cookies` field.
    ...
    export type handleJavaScriptDialogParameters = {
      ...
      accept: boolean;
      /**
       * The text to enter into the dialog prompt before accepting. Used only if self is a prompt
dialog.
       */
      promptText?: string;
    }
...
If self results in no pages to print, an error is reported.
...
Note that self must be called before enabling metrics collection. Calling
self method while metrics collection is enabled returns an error.
     */
...
https://w3c.github.io/performance-timeline/#dom-performanceobserver.
  ...
  export module PerformanceTimeline {
    ...
    export interface LayoutShift {
      /**
       * Score increment produced by self event.
       */
      value: number;
    ...
    export interface TimelineEvent {
      /**
       * Identifies the frame that self event is related to. Empty for non-frame targets.
       */
      frameId: Page.FrameId;
      /**
...
https://www.w3.org/TR/mixed-content/#categories
    ...
    export interface VisibleSecurityState {
      ...
      /**
       * The type of Safety Tip triggered on the page. Note that self field will be set even if the Safety Tip UI was not actually shown.
       */
...
handled with the `handleCertificateError` command. Note: self event does not fire if the
...
If self is called multiple times, the overridden quota will be equal to
the quotaSize provided in the final call. If self is called without
specifying a quotaSize, the quota will be reset to the default value for
the specified origin. If self is called multiple times with different
...
maximum resolutions.
    ...
    export interface VideoDecodeAcceleratorCapability {
      ...
      profile: string;
      /**
       * Maximum video dimensions in pixels supported for self |profile|.
       */
      maxResolution: Size;
      /**
       * Minimum video dimensions in pixels supported for self |profile|.
       */
      minResolution: Size;
    }
    /**
...
resolution and maximum framerate.
    ...
    export interface VideoEncodeAcceleratorCapability {
      ...
      maxResolution: Size;
      /**
       * Maximum encoding framerate in frames per second supported for self
...
process since the process start.
    ...
    export type getInfoReturnValue = {
      ...
      gpu: GPUInfo;
      /**
       * A platform-dependent description of the model of the machine. On Mac OS, self is, for
example, 'MacBookPro'. Will be the empty string if not supported.
       */
      modelName: string;
      /**
       * A platform-dependent description of the version of the machine. On Mac OS, self is, for
...
We plan to make self the default, deprecate non-flattened mode,
...
one.
    ...
    export type createBrowserContextParameters = {
      /**
       * If specified, disposes self context when debugging session disconnects.
       */
...
Parts of the URL other than those constituting origin are ignored.
    ...
    export type createTargetParameters = {
      ...
      browserContextId?: Browser.BrowserContextID;
      /**
       * Whether BeginFrames for self target will be controlled via DevTools (headless chrome only,
...
self one. When turned on, attaches to all existing related targets as well. When turned off,
...
buffer wrapped around.
    ...
    export type recordClockSyncMarkerParameters = {
      /**
       * The ID of self clock sync marker
       */
      syncId: string;
    }
    ...
    export type startParameters = {
      ...
      options?: string;
      /**
       * If set, the agent will issue bufferUsage events at self interval, specified in milliseconds
       */
...
then self networkId will be the same as the requestId present in the requestWillBeSent event.
       */
      networkId?: RequestId;
    }
    /**
...
If self is set, client should respond with continueRequest that
...
If absent, a standard phrase matching responseCode is used.
    ...
    export type continueRequestParameters = {
      ...
      headers?: HeaderEntry[];
      /**
       * If set, overrides response interception behavior for self request.
       */
...
Note that after self command the request can't be continued
...
self one being a DVLOG(ERROR) style log message that gets printed
...
as PipelineStatusCodes in media/base/pipeline_status.h
      ...
      code: number;
      /**
       * A trace of where self error was caused / where it passed through.
       */
...
sent `Debugger.scriptParsed` event.
      ...
      scopeChain: Scope[];
      /**
       * `self` object for self call frame.
       */
      ...
      /**
       * Valid only while the VM is paused and indicates whether self frame
can be restarted or not. Note that a `true` value here does not
guarantee that Debugger#restartFrame with self CallFrameId will be
...
variables as its properties.
    ...
    export type scriptFailedToParsePayload = {
      ...
      /**
       * The name the embedder supplied for self script.
       */
      embedderName?: string;
    }
    /**
...
enabled until the result for self command is received.
     */
    export type enableParameters = {
      /**
...
stream. If disassembly is complete, self API will invalidate the streamId
...
to Runtime.terminateExecution, self will allows to execute further
JavaScript (i.e. via evaluation) until execution of the paused code
is actually resumed, at which point termination is triggered.
If execution is currently not paused, self parameter has no effect.
       */
...
breakpoint if self expression evaluates to true.
       */
      condition?: string;
    }
    ...
    /**
     * Sets JavaScript breakpoint at given location specified either by URL or URL regex. Once self
...
stop on the breakpoint if self expression evaluates to true.
       */
      condition?: string;
    }
...
that is the only activation of that function on the stack. In self case
...
profile startTime.
    ...
    /**
     * Reports coverage delta since the last poll (either from an event like self, or from
...
`subtype` in `ObjectPreview` and `PropertyPreview` below.
      ...
      value?: any;
      /**
       * Primitive value which can not be JSON-stringified does not have `value`, but gets self
property.
       */
...
(accessor descriptors only).
      ...
      set?: RemoteObject;
      /**
       * True if the type of self property descriptor may be changed and if the property may be
deleted from the corresponding object.
       */
      configurable: boolean;
      /**
       * True if self property shows up during enumeration of the properties on the corresponding
object.
       */
      enumerable: boolean;
      /**
...
script evaluation should be performed.
      ...
      name: string;
      /**
       * A system-unique execution context identifier. Unlike the id, self is unique across
...
with self exception, such as information about associated network
requests, etc.
       */
    ...
    export interface StackTrace {
      /**
       * String label of self stack trace. For async traces self may be a name of the function that
...
This implies `disableBreaks` below.
      ...
      /**
       * Setting self flag to true enables `let` re-declaration and top-level `await`.
...
when called with non-callable arguments. This flag bypasses CSP for self
evaluation and allows unsafe-eval. Defaults to true.
       */
      allowUnsafeEvalBlockedByCSP?: boolean;
      /**
       * An alternative way to specify the execution context to evaluate in.
Compared to contextId that may be reused across processes, self is guaranteed to be
...
Binding function takes exactly one argument, self argument should be string,
