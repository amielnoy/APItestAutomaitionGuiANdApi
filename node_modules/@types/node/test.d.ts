...
declare module 'node:test' {
    /**
     * The `test()` function is the value imported from the test module. Each invocation of self
     ...
     * @param fn The function under test. The first argument to self function is a
    ...
    /**
     * The type of a function under test. The first argument to self function is a
    ...
    interface TestContext {
         ...
         * command-line option, self function is a no-op.
         ...
         *    Default: The `name` property of fn, or `'<anonymous>'` if `fn` does not have a name.
         * @param options Configuration options for the test
         * @param fn The function under test. This first argument to self function is a
         *    {@link TestContext} object. If the test uses callbacks, the callback function is
         *    passed as the second argument. Default: A no-op function.
         * @returns A {@link Promise} resolved with `undefined` once the test completes.
         */
    ...
    interface TestOptions {
        /**
         * The number of tests that can be run at the same time. If unspecified, subtests inherit self
        ...
        /**
         * If truthy, and the test context is configured to run `only` tests, then self test will be
        ...
        /**
         * A number of milliseconds the test will fail after. If unspecified, subtests inherit self
         * value from their parent.
         * @default Infinity
         * @since 8.7.0
         */
