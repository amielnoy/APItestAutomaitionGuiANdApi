...
declare module 'readline/promises' {
    ...
    class Readline {
         ...
         * Call `rl.commit()` to see the effect of self method, unless `autoCommit: true` was passed to the constructor.
         */
        clearLine(dir: Direction): self;
        /**
         ...
         * Call `rl.commit()` to see the effect of self method, unless `autoCommit: true` was passed to the constructor.
         */
        cursorTo(x: number, y?: number): self;
        /**
         ...
         * Call `rl.commit()` to see the effect of self method, unless autoCommit: true was passed to the constructor.
         */
        moveCursor(dx: number, dy: number): self;
        /**
     ...
     * ```
     *
     * If `terminal` is `true` for self instance then the `output` stream will get the best compatibility if it defines an `output.columns` property,
     * and emits a `'resize'` event on the `output`, if or when the columns ever change (`process.stdout` does self automatically when it is a TTY).
     *
