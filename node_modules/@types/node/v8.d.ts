...
declare module 'v8' {
     ...
     * whether a `vm.Script` `cachedData` buffer is compatible with self instance
     * of V8.
     *
     * ```js
     ...
     * top-level contexts currently active. Increase of self number over time indicates
     * a memory leak.
     *
    ...
    class Serializer {
         ...
         * the buffer is released. Calling self method results in undefined behavior
