...
declare module 'fs/promises' {
    ...
    interface FileHandle {
         ...
         * to with `fsPromises.open()`. Therefore, self is equivalent to `filehandle.writeFile()`.
         * @since v10.0.0
         ...
         *
         * Unlike `filehandle.sync` self method does not flush modified metadata.
         * @since v10.0.0
         * @return Fulfills with `undefined` upon success.
         */
         ...
         *
         * An error will be thrown if self method is called more than once or is called after the `FileHandle` is closed
         * or closing.
         *
         * ```js
         ...
         * without waiting for the promise to be resolved (or rejected). For self
