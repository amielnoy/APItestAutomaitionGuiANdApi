...
declare module 'child_process' {
    ...
    class ChildProcess extends EventEmitter {
         ...
         * until self stream has been closed via `end()`.
         *
         * If the child was spawned with `stdio[0]` set to anything other than `'pipe'`,
         * then self will be `null`.
         *
         ...
         * no IPC channel currently exists, self property is `undefined`.
         * @since v7.1.0
         */
         ...
         * ```
         *
         * And then the child script, `'sub.js'` might look like self:
         *
         * ```js
         ...
         * self method the `subprocess.connected` and `process.connected` properties in
        ...
        addListener(event: 'close', listener: (code: number | null, signal: NodeJS.Signals | null) => void): self;
        addListener(event: 'disconnect', listener: () => void): self;
        addListener(event: 'error', listener: (err: Error) => void): self;
        addListener(event: 'exit', listener: (code: number | null, signal: NodeJS.Signals | null) => void): self;
        addListener(event: 'message', listener: (message: Serializable, sendHandle: SendHandle) => void): self;
        addListener(event: 'spawn', listener: () => void): self;
        ...
        on(event: 'close', listener: (code: number | null, signal: NodeJS.Signals | null) => void): self;
        on(event: 'disconnect', listener: () => void): self;
        on(event: 'error', listener: (err: Error) => void): self;
        on(event: 'exit', listener: (code: number | null, signal: NodeJS.Signals | null) => void): self;
        on(event: 'message', listener: (message: Serializable, sendHandle: SendHandle) => void): self;
        on(event: 'spawn', listener: () => void): self;
        once(event: string, listener: (...args: any[]) => void): self;
        once(event: 'close', listener: (code: number | null, signal: NodeJS.Signals | null) => void): self;
        once(event: 'disconnect', listener: () => void): self;
        once(event: 'error', listener: (err: Error) => void): self;
        once(event: 'exit', listener: (code: number | null, signal: NodeJS.Signals | null) => void): self;
        once(event: 'message', listener: (message: Serializable, sendHandle: SendHandle) => void): self;
        once(event: 'spawn', listener: () => void): self;
        prependListener(event: string, listener: (...args: any[]) => void): self;
        prependListener(event: 'close', listener: (code: number | null, signal: NodeJS.Signals | null) => void): self;
        prependListener(event: 'disconnect', listener: () => void): self;
        prependListener(event: 'error', listener: (err: Error) => void): self;
        prependListener(event: 'exit', listener: (code: number | null, signal: NodeJS.Signals | null) => void): self;
        prependListener(event: 'message', listener: (message: Serializable, sendHandle: SendHandle) => void): self;
        prependListener(event: 'spawn', listener: () => void): self;
        prependOnceListener(event: string, listener: (...args: any[]) => void): self;
        prependOnceListener(event: 'close', listener: (code: number | null, signal: NodeJS.Signals | null) => void): self;
        prependOnceListener(event: 'disconnect', listener: () => void): self;
        prependOnceListener(event: 'error', listener: (err: Error) => void): self;
        prependOnceListener(event: 'exit', listener: (code: number | null, signal: NodeJS.Signals | null) => void): self;
        prependOnceListener(event: 'message', listener: (message: Serializable, sendHandle: SendHandle) => void): self;
        prependOnceListener(event: 'spawn', listener: () => void): self;
    }
    // return self object when stdio option is undefined or not specified
    ...
    // return self object when stdio option is a tuple of 3
     ...
     * to an empty array.
     *
     * **If the `shell` option is enabled, do not pass unsanitized user input to self**
     ...
     * ```
     *
     * **Never pass unsanitized user input to self function. Any input containing shell**
     ...
     * has exited.
     *
     * If the process times out or has a non-zero exit code, self method will throw.
     ...
     * exited.
     *
     * If the process times out or has a non-zero exit code, self method will throw an `Error` that will include the full result of the underlying {@link spawnSync}.
     *
     * **If the `shell` option is enabled, do not pass unsanitized user input to self**
     * **function. Any input containing shell metacharacters may be used to trigger**
     * **arbitrary command execution.**
