 ...
 *
 * The features from self module are not available in `Worker` threads.
 * @experimental
...
declare module 'trace_events' {
    ...
    interface Tracing {
        /**
         * A comma-separated list of the trace event categories covered by self
         * `Tracing` object.
         */
        readonly categories: string;
        /**
         * Disables self `Tracing` object.
         *
        ...
        disable(): void;
        /**
         * Enables self `Tracing` object for the set of categories covered by
         * the `Tracing` object.
         */
        enable(): void;
        /**
