...
class TestRapidApi(BaseApiTest):

    def testSearchapi(self):
        params = {"q": "taylor swift", "pageNumber": "1", "pageSize": "10", "autoCorrect": "true"}
        response = rapid_api_requests.http_get_rapid_api(url_suffix='/Search/ImageSearchAPI'
                                                         , params=params)
    ...
    def testnewSearchapi(self):
        ...
        response = rapid_api_requests.http_get_rapid_api(url_suffix='/search/NewsSearchAPI'
                                                         , params=params)
        Reporting.report_allure_and_logger("INFO", str(response.json()))
        print(response.json())
        time.sleep(3)
    ...
    def testWebsearch(self):
        params = {"q": "taylor swift", "pageNumber": "1", "pageSize": "10", "autoCorrect": "true"}
        response = rapid_api_requests.http_get_rapid_api(url_suffix='/Search/WebSearchAPI'
                                                         , params=params)
        ...
        expected_str = ['<b><b>taylor swift</b> video</b>', '<b><b>taylor swift</b> 000</b>',
                        '<b><b>taylor swift</b> homepage</b>',
                        '<b><b>taylor swift</b> web</b>', '<b>music <b>taylor swift</b></b>',
    ...
    def testSpellcheck(self):
        ...
        response = rapid_api_requests.http_get_rapid_api(url_suffix='/spelling/SpellCheck'
                                                         , params=params)
        Reporting.report_allure_and_logger("INFO", str(response.json()))
    ...
    def testAuto(self):
        params = {"text": "ram "}
        response = rapid_api_requests.http_get_rapid_api(url_suffix='/spelling/AutoComplete'
                                                         , params=params)
        Reporting.report_allure_and_logger("INFO", str(response.json()))
        print(response.content)
        time.sleep(3)
