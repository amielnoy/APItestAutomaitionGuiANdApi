...
# from pages.Settings.Detection.SettingsDetectionWhiteListSenderPage import SettingsDetectionSenderWhiteListPage
...
# class TestsSettingDetectionWhiteListSenderAcronis(BaseTest):
#
...
#     def _test_email_address_whitelist_acronis(self, setup_browser_page, read_non_secrets):
#         page = setup_browser_page
#         params_dictionary = read_non_secrets
#
#         settings_detection_sender_white_list_page = SettingsDetectionSenderWhiteListPage(page, is_acronis=True)
#         test_setting_detection_sender_white_list_ip = TestSettingDetectionItemList(
#             page
#             , settings_detection_sender_white_list_page
...
#
#         test_setting_detection_sender_white_list_ip.add_two_items_to_list()
#         # add second mail
#
