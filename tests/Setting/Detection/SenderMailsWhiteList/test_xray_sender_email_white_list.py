...
#     def _test_email_white_list_sender_xray(self, setup_browser_page, read_non_secrets):
#         page = setup_browser_page
#         params_dictionary = read_non_secrets
#
#         settings_detection_sender_white_list_page = SettingsDetectionSenderWhiteListPage(page, is_acronis=False)
