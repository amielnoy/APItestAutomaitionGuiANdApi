...
# from pages.Settings.Detection.SettingsDetection_SenderIP_BlackList_Page import SettingsDetectionSenderIpBlackListPage
...
# class TestsSettingDetectionBlackListSenderXray(BaseTest):
...
#     def _test_ip_black_list_sender(self, setup_browser_page, read_non_secrets):
#         page = setup_browser_page
#         params_dictionary = read_non_secrets
#         self.params_dictionary = params_dictionary
#         pp_url = params_dictionary.get("XRAY_BASE_URL")
#
#         settings_detection_black_list_sender_ip_page = SettingsDetectionSenderIpBlackListPage(page, pp_url,
#                                                                                               is_acronis=False)
...
#
#         test_setting_detection_black_list_ip.edit_and_save_changes(
#             test_setting_detection_black_list_ip.ip_address1)
