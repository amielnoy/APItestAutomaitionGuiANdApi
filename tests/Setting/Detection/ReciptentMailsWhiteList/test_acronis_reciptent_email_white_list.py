...
# class TestsSettingDetectionWhiteListReciptentAcronis(BaseTest):
#
...
#     def _test_reciptent_whitelist_acronis(self, setup_browser_page, read_non_secrets):
#         page = setup_browser_page
#         params_dictionary = read_non_secrets
#
#         settings_detection_reciptent_white_list_page = SettingsDetectionReciptentWhiteListPage(page, is_acronis=True)
