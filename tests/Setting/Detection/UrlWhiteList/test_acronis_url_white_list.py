...
# # 2.1 verify creation succsss message
# # 3.search for one
# # 4.verify one
# # 5.edit it
# # 6.delete 2 mails
...
# class TestsSettingDetectionUrlWhiteListAcronis(BaseTest):
#
...
#     def _test_url_address_whitelist_acronis(self, setup_browser_page, read_non_secrets):
#         page = setup_browser_page
#         params_dictionary = read_non_secrets
#
#         settings_detection_url_white_list_page = SettingsDetectionUrlWhiteListPage(page, is_acronis=True)
