...
#     def _test_sender_email_black_list(self, setup_browser_page, read_non_secrets):
#         page = setup_browser_page
#         params_dictionary = read_non_secrets
#
#         SettingsDetectionSenderBlackList_Page = SettingsDetectionSenderBlackListPage(page
#                                                                                      ,
#                                                                                      params_dictionary=params_dictionary
#                                                                                      , is_acronis=False)
#         test_setting_detection_sender_white_list_ip = TestSettingDetectionItemList(
#             page
#             , SettingsDetectionSenderBlackList_Page
#             , params_dictionary=params_dictionary
#             , is_acronis=False)
#
...
#
#         test_setting_detection_sender_white_list_ip.add_two_items_to_list(is_black_list_mail_sender=True)
#         # add second mail
#
