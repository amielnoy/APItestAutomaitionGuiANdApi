...
# from pages.Settings.Detection.SettingsDetectionWhiteListSenderIP_Page import \
#     SettingsDetectionSenderIpWhiteListPage
...
# class TestsSettingDetectionIpWhiteListSenderAcronis(BaseTest):
#
...
#     def _test_acronis_ip_address_whitelist_acronis(self, setup_browser_page, read_non_secrets):
#         page = setup_browser_page
#         params_dictionary = read_non_secrets
#         base_url = params_dictionary.get("ACRONIS_BASE_URL")
#
#         settings_detection_white_List_sender_ip_page = SettingsDetectionSenderIpWhiteListPage(page, is_acronis=True)
#         test_setting_detection_sender_white_list_ip = TestSettingDetectionItemList(
#             page
#             , settings_detection_white_List_sender_ip_page
...
#
#         test_setting_detection_sender_white_list_ip.add_two_items_to_list(is_ip_whitelist_address=True)
#
