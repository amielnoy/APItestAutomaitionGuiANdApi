...
# class TestsSettingDetectionWhiteListSenderXray(BaseTest):
#     # issue:
...
#     def _test_xray_ip_white_list_sender(self, setup_browser_page, read_non_secrets):
#         page = setup_browser_page
#         params_dictionary = read_non_secrets
#
#         settings_detection_white_list_sender_ip_page = SettingsDetectionSenderIpWhiteListPage(page, is_acronis=False)
