...
#
# class TestAcronisSelfAnlyzePassWordProtectedFile:
#     # Test Case in TestTrail direct link
#     project_root = ScanBase.get_project_root()
#     csv_path = ScanBase.get_csv_path_for_files("files_to_scan_acronis_password_protected.csv")
...
#     def _test_acronis_self_anlyze_file_password_protected(self, setup_browser_page, read_non_secrets):
...
#                                                                                   , is_acronis=True
#                                                                                   ,
#                                                                                   files_data=TestAcronisSelfAnlyzePassWordProtectedFile.files_data
