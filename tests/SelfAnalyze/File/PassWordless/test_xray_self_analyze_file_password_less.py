...
#
# class TestXraySelfAnlyzeFilePasswordLess:
#     project_root = ScanBase.get_project_root()
#     csv_path = ScanBase.get_csv_path_for_files("files_to_scan_xray_password_less.csv")
...
#     def _test_xray_self_anlyze_file_no_password(self, setup_browser_page, read_non_secrets):
...
#                                                           , is_acronis=False
#                                                           , files_data=TestXraySelfAnlyzeFilePasswordLess.files_data,
