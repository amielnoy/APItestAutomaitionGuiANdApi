...
class TestsEmailWizardXray(BaseTest):
    ...
    def test_xray_email_wizard_gmail(self, setup_browser_page, read_non_secrets, request):
    ...
    @allure.description('log to chrome and record video of the test')
    def test_xray_email_wizard_office365(self, setup_browser_page, read_non_secrets):
